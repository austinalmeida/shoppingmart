...
class ControllerModuleWebrotate360 extends Controller
{
	public function index()
    {
		...
		$data['action'] = $this->url->link('module/webrotate360', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->loadSetting($data, 'webrotate360_viewerWidth', '550px');
		...
		$this->response->setOutput($this->load->view('module/webrotate360.tpl', $data));
	}
