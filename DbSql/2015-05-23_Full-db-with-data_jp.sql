...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2015 at 07:53 AM
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.64560002, 1, '2015-05-23 06:46:49'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2015-05-23 06:58:37'),
(3, 'Euro', 'EUR', '', '€', '2', 0.90799999, 1, '2015-05-23 06:46:49');
...
(54, 14, 0, 'seller/account-%'),
(55, 15, 0, 'seller/catalog-seller'),
(56, 16, 0, 'seller/catalog-seller/profile'),
(57, 17, 0, 'seller/catalog-seller/products');
...
CREATE TABLE IF NOT EXISTS `ms_db_schema` (
  `schema_change_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ms_order_product_data` (
  `order_product_data_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
(1, 'samplv1sam', 'iPhone', '', 'sample this vender', 0, 0, '', '', 'sample1@sampl.com', '2015-05-23 10:12:14', 1, 1, 0, 1, NULL);
...
CREATE TABLE IF NOT EXISTS `ms_seller_group_criteria` (
  `seller_group_criteria_id` int(11) NOT NULL,
  `commission_id` int(11) NOT NULL,
  `criteria_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ms_seller_group_description` (
  `seller_group_description_id` int(11) NOT NULL,
  `seller_group_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ms_suborder_history` (
  `suborder_history_id` int(5) NOT NULL,
...
(50, 'iPhone', '', '', '', '', '', '', '', 999, 0, 'sellers/1/iphone.jpg', 0, 0, '300.0000', 0, 0, '2015-05-22', '0.00000000', 0, '0.00000000', '0.00000000', '0.00000000', 0, 0, 1, 0, 1, 0, '2015-05-23 10:13:42', '2015-05-23 10:13:42');
...
(50, 1, 'iPhone', 'sample this product and working good', 'iphone', '', '', '');
...
(280, 0, 'config', 'config_email', 'jayaprakasha@msourceone.com', 0),
...
(272, 0, 'config', 'config_maintenance', '', 0),
(273, 0, 'config', 'config_password', '1', 0),
(282, 0, 'config', 'config_encryption', '998641048073e55881a3e424c39795f3', 0),
...
(281, 0, 'config', 'config_url', 'http://smart.dd/', 0),
(284, 0, 'msconf', 'msconf_seller_validation', '1', 0),
(285, 0, 'msconf', 'msconf_product_validation', '1', 0),
(286, 0, 'msconf', 'msconf_allow_inactive_seller_products', '0', 0),
(287, 0, 'msconf', 'msconf_nickname_rules', '0', 0),
(288, 0, 'msconf', 'msconf_credit_order_statuses', 'a:1:{i:0;i:5;}', 1),
(289, 0, 'msconf', 'msconf_debit_order_statuses', 'a:1:{i:0;i:8;}', 1),
(290, 0, 'msconf', 'msconf_display_order_statuses', 'a:16:{i:0;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:4;i:5;i:5;i:6;i:6;i:7;i:7;i:8;i:8;i:9;i:9;i:10;i:10;i:11;i:11;i:12;i:12;i:13;i:13;i:14;i:14;i:15;i:15;i:16;}', 1),
(291, 0, 'msconf', 'msconf_minimum_withdrawal_amount', '50', 0),
(292, 0, 'msconf', 'msconf_allow_partial_withdrawal', '1', 0),
(293, 0, 'msconf', 'msconf_paypal_sandbox', '1', 0),
(294, 0, 'msconf', 'msconf_paypal_address', '', 0),
(295, 0, 'msconf', 'msconf_allow_withdrawal_requests', '1', 0),
(296, 0, 'msconf', 'msconf_allowed_image_types', 'png,jpg,jpeg', 0),
(297, 0, 'msconf', 'msconf_allowed_download_types', 'zip,rar,pdf', 0),
(298, 0, 'msconf', 'msconf_minimum_product_price', '0', 0),
(299, 0, 'msconf', 'msconf_maximum_product_price', '0', 0),
(300, 0, 'msconf', 'msconf_notification_email', '', 0),
(301, 0, 'msconf', 'msconf_allow_free_products', '0', 0),
(302, 0, 'msconf', 'msconf_allow_multiple_categories', '0', 0),
(303, 0, 'msconf', 'msconf_additional_category_restrictions', '0', 0),
(304, 0, 'msconf', 'msconf_restrict_categories', 'a:0:{}', 1),
(305, 0, 'msconf', 'msconf_product_included_fields', 'a:0:{}', 1),
(306, 0, 'msconf', 'msconf_images_limits', 'a:2:{i:0;i:0;i:1;i:0;}', 1),
(307, 0, 'msconf', 'msconf_downloads_limits', 'a:2:{i:0;i:0;i:1;i:0;}', 1),
(308, 0, 'msconf', 'msconf_enable_shipping', '0', 0),
(309, 0, 'msconf', 'msconf_provide_buyerinfo', '0', 0),
(310, 0, 'msconf', 'msconf_enable_quantities', '0', 0),
(311, 0, 'msconf', 'msconf_enable_categories', '0', 0),
(312, 0, 'msconf', 'msconf_physical_product_categories', 'a:0:{}', 1),
(313, 0, 'msconf', 'msconf_digital_product_categories', 'a:0:{}', 1),
(314, 0, 'msconf', 'msconf_disable_product_after_quantity_depleted', '0', 0),
(315, 0, 'msconf', 'msconf_allow_relisting', '0', 0),
(316, 0, 'msconf', 'msconf_enable_seo_urls_seller', '0', 0),
(317, 0, 'msconf', 'msconf_enable_seo_urls_product', '0', 0),
(318, 0, 'msconf', 'msconf_enable_update_seo_urls', '0', 0),
(319, 0, 'msconf', 'msconf_enable_non_alphanumeric_seo', '0', 0),
(320, 0, 'msconf', 'msconf_product_image_path', 'sellers/', 0),
(321, 0, 'msconf', 'msconf_predefined_avatars_path', 'avatars/', 0),
(322, 0, 'msconf', 'msconf_temp_image_path', 'tmp/', 0),
(323, 0, 'msconf', 'msconf_temp_download_path', 'tmp/', 0),
(324, 0, 'msconf', 'msconf_seller_terms_page', '', 0),
(325, 0, 'msconf', 'msconf_default_seller_group_id', '1', 0),
(326, 0, 'msconf', 'msconf_allow_specials', '1', 0),
(327, 0, 'msconf', 'msconf_allow_discounts', '1', 0),
(328, 0, 'msconf', 'msconf_withdrawal_waiting_period', '0', 0),
(329, 0, 'msconf', 'msconf_graphical_sellermenu', '1', 0),
(330, 0, 'msconf', 'msconf_enable_seller_banner', '1', 0),
(331, 0, 'msconf', 'msconf_enable_rte', '0', 0),
(332, 0, 'msconf', 'msconf_rte_whitelist', '', 0),
(333, 0, 'msconf', 'msconf_seller_avatar_seller_profile_image_width', '100', 0),
(334, 0, 'msconf', 'msconf_seller_avatar_seller_profile_image_height', '100', 0),
(335, 0, 'msconf', 'msconf_seller_avatar_seller_list_image_width', '228', 0),
(336, 0, 'msconf', 'msconf_seller_avatar_seller_list_image_height', '228', 0),
(337, 0, 'msconf', 'msconf_seller_avatar_product_page_image_width', '100', 0),
(338, 0, 'msconf', 'msconf_seller_avatar_product_page_image_height', '100', 0),
(339, 0, 'msconf', 'msconf_seller_avatar_dashboard_image_width', '100', 0),
(340, 0, 'msconf', 'msconf_seller_avatar_dashboard_image_height', '100', 0),
(341, 0, 'msconf', 'msconf_preview_seller_avatar_image_width', '100', 0),
(342, 0, 'msconf', 'msconf_preview_seller_avatar_image_height', '100', 0),
(343, 0, 'msconf', 'msconf_preview_product_image_width', '100', 0),
(344, 0, 'msconf', 'msconf_preview_product_image_height', '100', 0),
(345, 0, 'msconf', 'msconf_product_seller_profile_image_width', '100', 0),
(346, 0, 'msconf', 'msconf_product_seller_profile_image_height', '100', 0),
(347, 0, 'msconf', 'msconf_product_seller_products_image_width', '100', 0),
(348, 0, 'msconf', 'msconf_product_seller_products_image_height', '100', 0),
(349, 0, 'msconf', 'msconf_product_seller_product_list_seller_area_image_width', '40', 0),
(350, 0, 'msconf', 'msconf_product_seller_product_list_seller_area_image_height', '40', 0),
(351, 0, 'msconf', 'msconf_product_seller_banner_width', '750', 0),
(352, 0, 'msconf', 'msconf_product_seller_banner_height', '100', 0),
(353, 0, 'msconf', 'msconf_min_uploaded_image_width', '0', 0),
(354, 0, 'msconf', 'msconf_min_uploaded_image_height', '0', 0),
(355, 0, 'msconf', 'msconf_max_uploaded_image_width', '0', 0),
(356, 0, 'msconf', 'msconf_max_uploaded_image_height', '0', 0),
(357, 0, 'msconf', 'msconf_sellers_slug', 'sellers', 0),
(358, 0, 'msconf', 'msconf_attribute_display', '0', 0),
(359, 0, 'msconf', 'msconf_hide_customer_email', '0', 0),
(360, 0, 'msconf', 'msconf_hide_emails_in_emails', '0', 0),
(361, 0, 'msconf', 'msconf_hide_sellers_product_count', '1', 0),
(362, 0, 'msconf', 'msconf_avatars_for_sellers', '0', 0),
(363, 0, 'msconf', 'msconf_change_seller_nickname', '1', 0),
(364, 0, 'msconf', 'msconf_enable_private_messaging', '2', 0),
(365, 0, 'msconf', 'msconf_enable_one_page_seller_registration', '0', 0),
...
--
-- Indexes for table `ms_attribute_attribute`
--
ALTER TABLE `ms_attribute_attribute`
  ADD PRIMARY KEY (`ms_attribute_id`,`attribute_id`);
...
--
-- Indexes for table `ms_attribute_value`
--
ALTER TABLE `ms_attribute_value`
  ADD PRIMARY KEY (`attribute_value_id`);

--
-- Indexes for table `ms_attribute_value_description`
--
ALTER TABLE `ms_attribute_value_description`
  ADD PRIMARY KEY (`attribute_value_id`,`language_id`);

--
-- Indexes for table `ms_balance`
--
ALTER TABLE `ms_balance`
  ADD PRIMARY KEY (`balance_id`);

--
-- Indexes for table `ms_commission`
--
ALTER TABLE `ms_commission`
  ADD PRIMARY KEY (`commission_id`);

--
-- Indexes for table `ms_commission_rate`
--
ALTER TABLE `ms_commission_rate`
  ADD PRIMARY KEY (`rate_id`);

--
-- Indexes for table `ms_criteria`
--
ALTER TABLE `ms_criteria`
  ADD PRIMARY KEY (`criteria_id`);

--
-- Indexes for table `ms_db_schema`
--
ALTER TABLE `ms_db_schema`
  ADD PRIMARY KEY (`schema_change_id`);

--
-- Indexes for table `ms_order_comment`
--
ALTER TABLE `ms_order_comment`
  ADD PRIMARY KEY (`order_comment_id`);

--
-- Indexes for table `ms_order_product_data`
--
ALTER TABLE `ms_order_product_data`
  ADD PRIMARY KEY (`order_product_data_id`);
...
--
-- Indexes for table `ms_range_date`
--
ALTER TABLE `ms_range_date`
  ADD PRIMARY KEY (`range_id`);

--
-- Indexes for table `ms_range_decimal`
--
ALTER TABLE `ms_range_decimal`
  ADD PRIMARY KEY (`range_id`);

--
-- Indexes for table `ms_range_int`
--
ALTER TABLE `ms_range_int`
  ADD PRIMARY KEY (`range_id`);
...
--
-- Indexes for table `ms_seller_group`
--
ALTER TABLE `ms_seller_group`
  ADD PRIMARY KEY (`seller_group_id`);

--
-- Indexes for table `ms_seller_group_criteria`
--
ALTER TABLE `ms_seller_group_criteria`
  ADD PRIMARY KEY (`seller_group_criteria_id`);

--
-- Indexes for table `ms_seller_group_description`
--
ALTER TABLE `ms_seller_group_description`
  ADD PRIMARY KEY (`seller_group_description_id`);

--
-- Indexes for table `ms_suborder`
--
ALTER TABLE `ms_suborder`
  ADD PRIMARY KEY (`suborder_id`);

--
-- Indexes for table `ms_suborder_history`
--
ALTER TABLE `ms_suborder_history`
  ADD PRIMARY KEY (`suborder_history_id`);
...
--
-- Indexes for table `wr360product`
--
ALTER TABLE `wr360product`
  ADD PRIMARY KEY (`product_id`);
...
--
-- AUTO_INCREMENT for table `ms_attribute_value`
--
ALTER TABLE `ms_attribute_value`
  MODIFY `attribute_value_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_balance`
--
ALTER TABLE `ms_balance`
  MODIFY `balance_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_commission`
--
ALTER TABLE `ms_commission`
  MODIFY `commission_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ms_commission_rate`
--
ALTER TABLE `ms_commission_rate`
  MODIFY `rate_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `ms_criteria`
--
ALTER TABLE `ms_criteria`
  MODIFY `criteria_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_db_schema`
--
ALTER TABLE `ms_db_schema`
  MODIFY `schema_change_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ms_order_comment`
--
ALTER TABLE `ms_order_comment`
  MODIFY `order_comment_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_order_product_data`
--
ALTER TABLE `ms_order_product_data`
  MODIFY `order_product_data_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_payment`
--
ALTER TABLE `ms_payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_range_date`
--
ALTER TABLE `ms_range_date`
  MODIFY `range_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_range_decimal`
--
ALTER TABLE `ms_range_decimal`
  MODIFY `range_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_range_int`
--
ALTER TABLE `ms_range_int`
  MODIFY `range_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `ms_seller_group`
--
ALTER TABLE `ms_seller_group`
  MODIFY `seller_group_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ms_seller_group_criteria`
--
ALTER TABLE `ms_seller_group_criteria`
  MODIFY `seller_group_criteria_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_seller_group_description`
--
ALTER TABLE `ms_seller_group_description`
  MODIFY `seller_group_description_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ms_suborder`
--
ALTER TABLE `ms_suborder`
  MODIFY `suborder_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ms_suborder_history`
--
ALTER TABLE `ms_suborder_history`
  MODIFY `suborder_history_id` int(5) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=406;
--
